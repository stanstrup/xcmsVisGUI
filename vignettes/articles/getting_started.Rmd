...
- The **Spectrum** view defaults to **Raw**: you opened it to look at the data, and
  ...
  is, not sticks) and the title is marked *profile*. Clicking a peak still gives the
  true peak *m/z* — the click snaps to the apex, not to whichever flank sample you
  hit. Switch to **Centroid profile scans** for a conventional stick spectrum.

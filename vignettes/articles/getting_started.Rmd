...
The third mode, **Force centroid (all scans)**, peak-picks every level, even ones
the file flags as already centroided.

When centroiding is on, three settings appear:
...
- **m/z refinement** — recompute each centroid's *m/z* as the intensity-weighted
  mean of the ± N neighbouring raw points (0 = use the apex as-is). A small value
  (2–3) improves mass accuracy on profile data.

...
default *auto*). This matters most here: mapping a profile file raw means tens of
millions of points — one test file goes from 29 million points (690 MB) to 2 million
(48 MB) once picked. You can set the filter to *Never* to map every raw sample, but
expect it to be slow. See [Getting started](getting_started.html#profile-mode-data).

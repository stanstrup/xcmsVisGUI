...
A local Shiny desktop app (packaged as an R package) for interactively
visualising **raw LC-MS data** on the RforMassSpectrometry stack
(`Spectra` / `MsExperiment` / `xcms`). Plots are ggplot2 rendered

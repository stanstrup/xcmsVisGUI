...
- **Isotope pattern (formula)** — overlays a *theoretical fine isotope pattern* on
  ...
  (with mass error and DBE) from the **Elements** you select — the default set
  includes the halogens and alkali metals (Cl, Na, K) common in metabolomics, and
  more can be added. Pick a row and its pattern —
  [enviPat](https://cran.r-project.org/package=enviPat) isotopologues simulated as
  a profile envelope at the **Resolving power** you set — is drawn (green) over the
  data, scaled to the anchor. Higher resolving power separates the fine structure;

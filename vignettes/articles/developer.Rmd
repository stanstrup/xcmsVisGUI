...
The formula-based isotope-pattern overlay is **not** auto-captured: switching that
annotation mode programmatically fights Shiny's conditionalPanel input transmission
and output suspension (the candidate table computes 0 despite the engine returning
matches). Capture it by hand if needed — Spectrum → Annotate → Mode: *Isotope
pattern (formula)* → pick a formula — or export just that plot via its **Save**
button.
